package dev.folomkin.personservice.service;

import jakarta.transaction.Transactional;
import lombok.RequiredArgsConstructor;
import lombok.Setter;
import lombok.extern.slf4j.Slf4j;
import dev.folomkin.person.dto.IndividualDto;
import dev.folomkin.person.dto.IndividualPageDto;
import dev.folomkin.person.dto.IndividualWriteDto;
import dev.folomkin.person.dto.IndividualWriteResponseDto;
import dev.folomkin.personservice.exception.PersonException;
import dev.folomkin.personservice.mapper.IndividualMapper;
import dev.folomkin.personservice.repository.IndividualRepository;
